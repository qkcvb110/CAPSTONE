...
//	 	  i++;
//	 	  }
//	 	 sprintf ((char *)TxData_Node2_To_Node3, "hello%d",indx);
//	 	if (HAL_FDCAN_AddMessageToTxFifoQ(&hfdcan1, &TxHeader, TxData_Node2_To_Node3)!= HAL_OK)
//	 		 	             {
//	 		 	                Error_Handler();
//	 		 	             }
...
//	 	HAL_Delay(500);
//	    PowerOn_7_SEG_D1();
//	   	_7_SEG_Num_Test(RxData_From_Node3[0]);
//	   	HAL_Delay(0);
//	  	PowerOff_7_SEG_D1();
//	   	PowerOn_7_SEG_D2();
//	   	_7_SEG_Num_Test(RxData_From_Node3[1]);
//	   	HAL_Delay(0);
//	   	PowerOff_7_SEG_D2();
//	   	PowerOn_7_SEG_D3();
//	   	_7_SEG_Num_Test(RxData_From_Node3[2]);
//	   	HAL_Delay(0);
//	   	PowerOff_7_SEG_D3();
//	   	PowerOn_7_SEG_D4();
